...
export default function OpenAIPathGenerator() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-center">OpenAI Learning Path Generator</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-center">
            <button
              ...
              className="px-6 py-2 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors"
            >
      ...
      {loading && (
        <div className="mt-8 space-y-2">
          <p className="text-center text-gray-600">Generating your personalized learning path...</p>
          <ProgressBar />
        </div>
      )}
